<?php $__env->startSection('content'); ?>
	...
	<div class="page-content-wrapper">
		...
		<div class="page-content">
			...
			<a href="<?php echo e(route('addService')); ?>"><button type="button" class="btn blue-hoki pull-right">إضافة خدمة</button></a>
			<a href="<?php echo e(route('addProject')); ?>"><button type="button" class="btn blue-madison pull-right margin-right-10">إضافة مشروع</button></a>
							...
							<tbody>
											...
											<td class="text-center">
												<div class="btn-group">
													...
													<ul class="dropdown-menu pull-right bg-grey-cararra">
														<li><a href="<?php echo e(route('projectDetails', ['id' => $project->id])); ?>" class="font-purple"><i class="icon-eye font-purple"></i> عـرض</a></li>
								...
								<?php if($services): ?>
									<?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<td class="text-center">
												<div class="btn-group">
													...
													<ul class="dropdown-menu pull-right bg-grey-cararra">
														<li><a href="<?php echo e(route('serviceDetails', ['id' => $service->id])); ?>" class="font-purple"><i class="icon-eye font-purple"></i> عـرض</a></li>
														<li><a href="<?php echo e(route('editService', ['id' => $service->id])); ?>" class="font-blue"><i class="icon-note font-blue"></i> تعديل</a></li>
														<li>
															<a href="#deleteService<?php echo e($service->id); ?>" class="font-red" data-toggle="modal">
															<i class="icon-trash font-red"></i> حـذف</a>
														</li>
														<li>
															<a href="<?php echo e(route('downloadService', ['id' => $service->id])); ?>" class="font-green">
										...
										<div class="modal fade" id="deleteService<?php echo e($service->id); ?>" tabindex="-1" role="basic" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content del-modal font-white">
														...
														<div class="modal-body text-center">
															...
															متأكد أنك تريد حـذف الخدمة <?php echo e($service->name); ?> ؟
											
														</div>
														<div class="modal-footer">
															<button type="button" class="btn dark btn-default" data-dismiss="modal">إغلاق</button>
															<a href="<?php echo e(route('deleteService', ['id' => $service->id])); ?>" class="btn btn-danger">حـذف</a>
														</div>
													</div>
													<!-- /.modal-content -->
												</div>
