...
<head>
    ...
    <link href="{{ asset('assets/layouts/layout/css/font.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('assets/layouts/layout/css/themes/grey.css') }}" rel="stylesheet" type="text/css" id="style_color" />
    <link href="{{ asset('assets/layouts/layout/css/custom.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/layouts/layout/css/sBar.css') }}" rel="stylesheet" type="text/css" />
